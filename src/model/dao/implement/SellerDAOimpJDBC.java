...
public class SellerDAOimpJDBC implements SellerDAO {
    ...
    private Seller instantiateSeller(ResultSet rs, Department dep) throws SQLException{ // Função seller para reúso!
    ...
    private Department instantiateDepartment(ResultSet rs) throws SQLException{ // Função department  para reúso!
